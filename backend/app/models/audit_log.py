...
class AuditAction(str, enum.Enum):
    ...
    # Security Events (Phase 3 enhancements)
    ACCOUNT_LOCKED = "ACCOUNT_LOCKED"
    ACCOUNT_UNLOCK_ATTEMPT = "ACCOUNT_UNLOCK_ATTEMPT"
    ...
    ID_VERIFICATION_ADMIN_APPROVED = "ID_VERIFICATION_ADMIN_APPROVED"
    ID_VERIFICATION_ADMIN_REJECTED = "ID_VERIFICATION_ADMIN_REJECTED"
